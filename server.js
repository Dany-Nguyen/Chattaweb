...
// retourne un objet user pour le switch push -> autre methode
...
app.post('/sendMessage', function(req, res){
	...
	//si des clients en mode push sont connectés, on leur fait parvenir le message
	if(areSockClients()){
...
// les long-pollers restent en attente avec un timeout qui est interrompu si il y a des nouveau messages
app.post('/register-lp', function(req, res){
	...
	var lpInterval = setInterval(function() {
		...
		if(oldversion < messages.length ){	// si il y a + de messages dans la base
...
// retier un utilisateur de la base
